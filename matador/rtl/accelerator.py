...
class TMAccelerator:
    ...
    def _gen_tm_top(self) -> str:
        ...
        return (
            ...
            f"    // Declared before the FIFO block below, which reads `state` in a\n"
            f"    // continuous assign -- Icarus Verilog requires the declaration to\n"
            f"    // precede that use textually (unlike some other tools/Verilator).\n"
            f"    reg [2:0]      state;\n"
